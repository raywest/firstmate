...
Because every pin resolves from the file on each spawn, it is durable across recovery, `/updatefirstmate`, and restart.
This is secondmate-only: crewmate/scout launch-axis resolution is untouched by this file.
