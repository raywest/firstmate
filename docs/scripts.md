...
| `fm-project-mode.sh`     | Resolve a project's registered delivery and workspace posture from `data/projects.md` for fleet sync, home seeding, and the spawn's in-place check |
