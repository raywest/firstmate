...
kimi profile without effort is accepted^{"rules":[{"when":"bulk mechanical work","use":{"harness":"kimi","model":"kimi-code/k3"}}]}^empty^
unsupported kimi effort is flagged^{"rules":[{"when":"bulk mechanical work","use":{"harness":"kimi","effort":"high"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: kimi:high
