...
# Kimi's busy-signature scoping (moon-plus-middot spinner, harness-isolated
# from Grok's cancel token) is owned by tests/fm-kimi-harness.test.sh, which
# tests it against fm_pane_is_busy directly.
