...
# inside a Claude session would otherwise hand down to every worker pane later
# launched under it (first observed 2026-08-03, Claude Code 2.1.220; reproduced
# on tmux and this fix verified 2026-08-30, Claude Code 2.1.251 -
...
# Bounded poll for the server to report running. Every other fm_backend_herdr_cli
# call is left untouched; only the server's own environment needs scrubbing.
