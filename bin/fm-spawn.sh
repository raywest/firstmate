...
# a direct report (see bin/fm-gate-refuse-lib.sh). Source fm-wake-lib.sh only
# after this check clears - it creates $STATE as a sourcing side effect, which
# would otherwise mutate gate-adjacent state before the refusal fires.
