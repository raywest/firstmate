...
# no-mistakes run-step attributed to this crew's branch, else foreground-busy or
# harness-tracked-background-work pane evidence) and reconciles the possibly-stale
# log against it.
#
